...
<div class="join gap-2 mx-auto">
  <a class="btn btn-success join-item" href="{{ url('users/create') }}"><svg xmlns="http://www.w3.org/2000/svg"
  ...
  <a class="join-item btn btn-info" href="{{ url('export/users/excel') }}"><svg xmlns="http://www.w3.org/2000/svg"
      class="size-6" fill="currentColor" viewBox="0 0 256 256">
      <path
